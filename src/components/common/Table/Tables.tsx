...
function Tables() {
    ...
    console.log("selectedProject", CheckDeleteButton)
    ...
    //         dispatch(deleteProject({ projectID: project?.projectID || "", status: project?.status || "" }));
    //     });
    // };
    ...
    const projects=[
        {
            ...
            lastChecked: "2023-09-01 12:00:00"
        },
        {
            projectID: "2",
            status: "inactive",
            ...
            lastChecked: "2023-09-01 12:05:00"
        },]
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <Button name="Delete Project"
                            disableButton={CheckDeleteButton ? true : false}
                        />
                        </div>
                        ...
                        <tr className="text-left">
                            <th className="py-4 w-[5%]">
                                <input type="checkbox"
                                    ...
                                    // onChange={(e) => {
                                    //     if (e.target.checked) {
                                    //         setSelectedProject(projects.map((item) => item?.projectID || ""));
